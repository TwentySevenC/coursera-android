...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> arrayList = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
        Integer[] rawTextFeedIds = new Integer[arrayList.size()];
        rawTextFeedIds = arrayList.toArray(rawTextFeedIds);
		
		
		// TODO: Start the DownloaderTask
        downloaderTask.execute(rawTextFeedIds);
			...
			mContext.sendOrderedBroadcast(new Intent(
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (! (getResultCode() == MainActivity.IS_ALIVE)/*true || false*/) {
